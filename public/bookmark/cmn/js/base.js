...
// copyright demokevin, licensed duitang.com
// version 1.0.110523
*/
(function(a) {
    ...
    a.fn.confirm = function(i, d, c) {
        ...
        var j = a("#PL-confirm");
        if (!j.length) {
            j = a('<div id="PL-confirm" class="PL-confirm"><div class="PL-cfm-cont"><div class="PL-cfm-wds tc">' + h + '</div><div class="PL-cfm-btns tc"><a class="abtn abtn-s PL-cfm-yes dib" href="javascript:;""><u>确定</u></a><a class="abtn abtn-s PL-cfm-no dib" target="_self" href="javascript:;"><u>取消</u></a></div></div></div>').appendTo("body");
            var e = function() {
                var k = j.outerHeight();
                b(0, k)
            };
