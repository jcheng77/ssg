class Notification
  ...
  def self.add(object_id, sender_id, receiver_id, type)
    if !Notification.first(conditions: {object_id_type: object_id, sender_id: sender_id, receiver_id: receiver_id})
      ...
      Notification.new(object_id_type: object_id, sender_id: sender_id, receiver_id: receiver_id, type: type).save
    end
  end
end
