class Notification
  ...
  field :object_id, type: BSON::ObjectId # item_id/share_id/comment_id/recommend_id of this notification
  ...
  def self.add(object_id, sender_id, receiver_id, type)
    if !Notification.first(conditions: {object_id: object_id, sender_id: sender_id, receiver_id: receiver_id})
      object_id = BSON::ObjectId(object_id.to_s) unless !object_id.is_a? BSON::ObjectId
      ...
      Notification.new(object_id: object_id, sender_id: sender_id, receiver_id: receiver_id, type: type).save
    end
  end
end
